...
(* OASIS_START *)
(* DO NOT EDIT (digest: e4325752fb5f68b6d1a4389f92853cba) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-net-macosx";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "a…\154\b[Ã\019±\129 X¿\0288≥“";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
